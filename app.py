...
def compliments_results():
    ...
    context = {
        ...
        'complimentsList': random.sample(list_of_compliments, int(request.args.get('num_compliments')))
    }
...
def animal_facts():
    ...
    if chosenAnimal is None:
        chosenAnimal = default_animal
    ...
    context = {
        ...
        'animal': chosenAnimal,
        'animalToFactList': animal_to_fact.keys(),
        'animalFAct': animal_to_fact[chosenAnimal]
    }
...
def gif_search():
    ...
    if request.method == 'POST':
        ...
        gifs_amount = request.form.get('quantity')
